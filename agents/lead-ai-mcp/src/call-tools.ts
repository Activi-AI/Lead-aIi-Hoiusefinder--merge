      ...
      if (!VONAGE_API_KEY || !VONAGE_API_SECRET) {
        return {
          content: [
            {
              type: "text",
              text: "â Vonage nicht konfiguriert. Bitte VONAGE_API_KEY und VONAGE_API_SECRET in .env setzen.",
            },
          ],
        };
      }
      ...
      if (!VONAGE_APPLICATION_ID || !VONAGE_PRIVATE_KEY) {
        return {
          content: [
            {
              type: "text",
              text: "â Vonage Voice nicht konfiguriert. Bitte VONAGE_APPLICATION_ID und VONAGE_PRIVATE_KEY in .env setzen.",
            },
          ],
        };
      }
      ...
      try {
        ...
        return {
          content: [
            {
              type: "text",
              text: `â Fehler: ${error instanceof Error ? error.message : "Unknown"}`,
            },
          ],
        };
      }
      ...
      if (!SIPGATE_TOKEN || !SIPGATE_TOKEN_ID) {
        return {
          content: [
            {
              type: "text",
              text: "â Sipgate nicht konfiguriert. Bitte SIPGATE_TOKEN_ID und SIPGATE_TOKEN in .env setzen.",
            },
          ],
        };
      }
      ...
      if (!MAKE_WEBHOOK_URL) {
        return {
          content: [
            {
              type: "text",
              text: "â Make.com Webhook URL nicht konfiguriert. Bitte MAKE_WEBHOOK_URL in .env setzen.",
            },
          ],
        };
      }
